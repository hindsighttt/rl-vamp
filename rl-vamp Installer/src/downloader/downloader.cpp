...
Downloader::Downloader() {
	...
	releaseVer.url = "https://github.com/hindsighttt/rl-vamp/releases/latest/download/rl-vamp_Release.dll";
	releaseVer.filename = "rl-vamp_Release.dll";

	DownloadItem debugVer;
	debugVer.url = "https://github.com/hindsighttt/rl-vamp/releases/latest/download/rl-vamp_Debug.dll";
